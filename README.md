...
|-----------|------|----------|-------------|---------|
| `userPrincipalName` | string | Yes | User Principal Name (UPN) of the user | None |
| `roleId` | string | Yes | Directory role definition ID to assign | None |
| `directoryScopeId` | string | No | Directory scope ID for the role assignment | "/" |
| `justification` | string | No | Justification for the role assignment | "Approved by SGNL.ai" |
